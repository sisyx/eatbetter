          ...
          <div className="mx-6 py-10 text-center md:text-left">
            <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className={language === "fa" ? "text-right" : "text-left"} dir={language === "fa" ? "rtl" : "ltr"}>
                ...
                <p className="mb-4">
                  <Link to="/about">{t("footerCompany.aboutUs")}</Link>
                </p>
                <p className="mb-4">
                  <Link to="/contacts">{t("footerCompany.contactUs")}</Link>
                </p>
                <p className="mb-4">
                  <Link to="/cooperate">{t("footerCompany.corporateWithUs")}</Link>
                </p>
              </div>
              ...
              <div className={language === "fa" ? "text-right" : "text-left"} dir={language === "fa" ? "rtl" : "ltr"}>
                ...
                <p className="mb-4">
                  <Link to="/">{t("footerHelpLink.home")}</Link>
                </p>
                <p className="mb-4">
                  <Link to="/blog">{t("footerHelpLink.blog")}</Link>
                </p>
                <p className="mb-4">
                  <Link to="/diets">{t("footerHelpLink.diets")}</Link>
                </p>
                <p>
                  <Link to="/sleep">{t("footerHelpLink.sleepSoulMentality")}</Link>
                </p>
              </div>
